...
describe("atmospheric dataset capability catalog", () => {
  ...
  it("advertises only operations actually implemented for each dataset", () => {
    ...
    expect(datasetSupportsOperation("aigfs_0p25", "aligned_model_comparison")).toBe(true);
    ...
    expect(datasetSupportsOperation("aigefs_0p25", "aligned_model_comparison")).toBe(true);
    ...
    expect(datasetSupportsOperation("icon_d2_0p02", "aligned_model_comparison")).toBe(true);
    ...
    expect(datasetSupportsOperation("icon_d2_eps_2p1km", "aligned_model_comparison")).toBe(true);
    ...
    expect(datasetSupportsOperation("arome_0p01", "aligned_model_comparison")).toBe(true);
    ...
    expect(datasetSupportsOperation("pe_arome_0p025", "aligned_model_comparison")).toBe(true);
    ...
    expect(datasetSupportsOperation("aifs_0p25", "aligned_model_comparison")).toBe(true);
  ...
  it("keeps the model registry vocabulary limited to operational forecast models", () => {
    ...
    expect(modelSupportsOperation("aigfs_0p25", "aligned_model_comparison")).toBe(true);
    ...
    expect(modelSupportsOperation("aigefs_0p25", "aligned_model_comparison")).toBe(true);
    ...
    expect(modelSupportsOperation("icon_d2_0p02", "aligned_model_comparison")).toBe(true);
    expect(modelSupportsOperation("icon_d2_eps_2p1km", "ensemble_distribution")).toBe(true);
    expect(modelSupportsOperation("icon_d2_eps_2p1km", "aligned_model_comparison")).toBe(true);
    ...
    expect(modelSupportsOperation("arome_0p01", "aligned_model_comparison")).toBe(true);
    ...
    expect(modelSupportsOperation("pe_arome_0p025", "aligned_model_comparison")).toBe(true);
