...
describe("atmospheric dataset capability catalog", () => {
  ...
  it("advertises only operations actually implemented for each dataset", () => {
    ...
    expect(datasetSupportsOperation("aigfs_0p25", "alignment")).toBe(true);
    ...
    expect(datasetSupportsOperation("aigefs_0p25", "alignment")).toBe(true);
    expect(datasetSupportsOperation("hgefs_0p25", "profile")).toBe(true);
    expect(datasetSupportsOperation("hgefs_0p25", "ensemble_distribution")).toBe(true);
    expect(datasetSupportsOperation("hgefs_0p25", "parcel_diagnostics")).toBe(false);
    expect(datasetSupportsOperation("hgefs_0p25", "alignment")).toBe(true);
    ...
    expect(datasetSupportsOperation("icon_d2_0p02", "alignment")).toBe(true);
    ...
    expect(datasetSupportsOperation("icon_d2_eps_2p1km", "alignment")).toBe(true);
    expect(datasetSupportsOperation("arome_0p01", "profile")).toBe(true);
    ...
    expect(datasetSupportsOperation("arome_0p01", "alignment")).toBe(true);
    ...
    expect(datasetSupportsOperation("pe_arome_0p025", "alignment")).toBe(true);
    ...
    expect(datasetSupportsOperation("aifs_0p25", "alignment")).toBe(true);
    ...
    expect(datasetSupportsOperation("aifs_ens_0p25", "alignment")).toBe(true);
    expect(datasetSupportsOperation("gefs_0p50", "profile")).toBe(true);
    expect(datasetSupportsOperation("gefs_0p50", "alignment")).toBe(true);
    expect(datasetSupportsOperation("ifs_0p25", "profile")).toBe(true);
    expect(datasetSupportsOperation("ifs_0p25", "alignment")).toBe(true);
    ...
    expect(datasetSupportsOperation("gfs_grid4_analysis_0p5", "alignment")).toBe(true);
  ...
  it("keeps the model registry vocabulary limited to operational forecast models", () => {
    ...
    expect(modelSupportsOperation("gfs_0p50", "alignment")).toBe(true);
    expect(modelSupportsOperation("ifs_0p25", "alignment")).toBe(true);
    expect(modelSupportsOperation("aigfs_0p25", "profile")).toBe(true);
    expect(modelSupportsOperation("aigfs_0p25", "alignment")).toBe(true);
    ...
    expect(modelSupportsOperation("aigefs_0p25", "alignment")).toBe(true);
    ...
    expect(modelSupportsOperation("hgefs_0p25", "alignment")).toBe(true);
    ...
    expect(modelSupportsOperation("icon_d2_0p02", "alignment")).toBe(true);
    expect(modelSupportsOperation("icon_d2_eps_2p1km", "ensemble_distribution")).toBe(true);
    expect(modelSupportsOperation("icon_d2_eps_2p1km", "alignment")).toBe(true);
    ...
    expect(modelSupportsOperation("arome_0p01", "alignment")).toBe(true);
    ...
    expect(modelSupportsOperation("pe_arome_0p025", "alignment")).toBe(true);
    expect(modelSupportsOperation("aifs_0p25", "profile")).toBe(true);
    expect(modelSupportsOperation("aifs_0p25", "alignment")).toBe(true);
    ...
    expect(modelSupportsOperation("aifs_ens_0p25", "alignment")).toBe(true);
    ...
    expect(modelSupportsOperation("ifs_ens_0p25", "alignment")).toBe(true);
  });
});
