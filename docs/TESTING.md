...
- deterministic and member-first pressure-profile thermodynamics, including AIGEFS reuse of the AIGFS deterministic kernel per member, HGEFS member-first GEFS+AIGEFS composition, and AIFS ENS reuse of the AIFS deterministic atmospheric kernel per member;
