...
export function createMcpServer(): McpServer {
  const server = new McpServer(
    ...
    {
      instructions: [
        "WFG exposes one atmospheric query language across operational GFS, GEFS, deterministic ECMWF IFS, ECMWF IFS ENS, and historical GFS analysis.",
        "Use search_catalog for discovery, query_atmosphere for atmospheric state, diagnose_atmosphere for layer/profile/parcel physics, compare_runs and compare_datasets for forecast comparison, verify_forecast for forecast verification against historical GFS analysis or IGRA soundings, and find_analogs for local historical analog search.",
