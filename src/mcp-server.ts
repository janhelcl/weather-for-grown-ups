  ...
  const server = new McpServer(
    { name: "weather-for-grown-ups", version: "0.1.0" },
    {
      instructions: [
        ...
        "Public dataset IDs are gfs, gefs, and gfs-analysis. Dataset-native semantics are preserved: GFS is deterministic forecast data, GEFS is member-first ensemble forecast data, and gfs-analysis is historical model analysis rather than observations or homogeneous reanalysis.",
