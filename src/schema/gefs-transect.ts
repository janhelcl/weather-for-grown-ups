...
const sampleSchema = z.object({
  ...
  pressureSummaries: gefsPointsBundleResultSchema.shape.points.element.shape.pressureSummaries,
  fieldSummaries: gefsPointsBundleResultSchema.shape.points.element.shape.fieldSummaries,
  members: gefsPointsBundleResultSchema.shape.points.element.shape.members,
});
