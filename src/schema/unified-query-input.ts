...
export const queryAtmosphereInputSchema = z.strictObject({
  ...
  diagnostics: z.array(atmosphericDiagnosticSelectionSchema).min(1).optional(),
...
export function parseQueryAtmosphereInput(input: PublicQueryAtmosphereInput): ParsedQueryAtmosphereInput {
