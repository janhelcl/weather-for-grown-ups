...
import { atmosphericSelectionSchema, queryAtmosphereSchema, type PublicAtmosphericDataset, type QueryAtmosphereInput } from "./unified-api.js";
...
export function normalizeQueryAtmosphereInput(input: PublicQueryAtmosphereInput): QueryAtmosphereInput {
