...
function registerQueryCommand(program: Command): void {
  program
    ...
    .option("--dataset <gfs|aigfs|aigefs|gefs|ifs|ifs-ens|gfs-analysis>", "Atmospheric dataset", "gfs")
    ...
    .option("--members <list>", "Ensemble members: AIGEFS 000..030, GEFS c00,p01..p30, or IFS ENS p01..p50")
