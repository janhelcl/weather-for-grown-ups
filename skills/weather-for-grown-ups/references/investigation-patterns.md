...
1. Align valid time and inspect the deterministic fields that directly express the disagreement.
...
6. Report sampling/resolution differences and avoid generic cross-grid subtraction outside registered comparison semantics.
...
4. Compare the latest and previous runs when forecast convergence or instability matters.
...
4. Use an explicitly registered cross-scale comparison when available.
